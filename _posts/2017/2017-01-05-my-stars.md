...
* Auth
  * [login-with](https://github.com/lipp/login-with)
...
* [webcomponents]
  ...
  * [skatejs](https://github.com/skatejs/skatejs): Write functional and performant web components with a very small footprint
...
* [DOM]
  ...
  * [morphdom](https://github.com/patrick-steele-idem/morphdom#benchmarks): Fast and lightweight DOM diffing/patching (no virtual DOM needed)
* Template Engine
  * [mustache]()
  * [superviews.js](https://github.com/davidjamesstone/superviews.js): Template engine targeting incremental-dom.
* Browser
...
* Animation
  * [iconate](https://bitshadow.github.io/iconate/): Transform your icons with trendy animations.
...
* WPA
  * [lavas](https://github.com/lavas-project/pwa-doc): 基于 Vue 的 PWA 解决方案，帮助开发者快速搭建 PWA 应用，解决接入 PWA 的各种问题.
* 人机验证
  * [腾讯验证码](http://open.captcha.qq.com/index.html)
...
# Design
* [coolhue](https://webkul.github.io/coolhue/): Coolest handpicked Gradient Hues for your next super ⚡ amazing stuff.
...
* [pkg](https://github.com/zeit/pkg): bundle js to executable file
* video
...
* Javascript Quality
  ...
  * [Clean JavaScript](https://segmentfault.com/a/1190000008039771):写出整洁的JavaScript代码
* unit test
  * [ava]
  * [jest]
  * [mocha]
...
* docs
  ...
  * [Developer roadmap](https://github.com/kamranahmedse/developer-roadmap): a roadmap for frontend & backend developers
  * [Become-A-Full-Stack-Web-Developer](https://github.com/bmorelli25/Become-A-Full-Stack-Web-Developer): sources for full-stack-web-developer
  * [papers-we-love](https://github.com/papers-we-love/papers-we-love): how to read papers?
  * [awesome](https://github.com/sindresorhus/awesome): a awesome project for awesome projects
  * [free-programming-books](https://github.com/vhf/free-programming-books): Learn some more details
* Create docs
  * [docsify: A magical documentation site generator.](https://github.com/QingWei-Li/docsify)
* Learning
  ...
  * [Resources](https://github.com/mezod/awesome-indie) for independent developers to make money
    * [x] [I’m Launching 12 Startups in 12 Months](https://levels.io/12-startups-12-months/)
  * [front-end-handbook](https://github.com/xitu/front-end-handbook-2017)
...
# CSS
  * [primer-css](https://github.com/primer/primer-css): Github CSS.
