...
正常走 vscode 的 proxy 配置即可，仅支持非 cloudflare 代理，且仅支持 http (http://127.0.0.1:1090) 不支持 socks5，配置后最好重启 vscode。

continue 的 proxy 属性有些 bug，代理不上。

# Cloudflare AI Gateway

新建一个 ai gateway，更换 apibase 即可，如：`https://gateway.ai.cloudflare.com/v1/xxxxx/myopenrouter/openrouter`
