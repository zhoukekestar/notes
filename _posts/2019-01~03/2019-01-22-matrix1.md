...
方法1：A combination of the columns of the matrix.（矩阵列的线性组合）
...
* 确定 pivot（主元）A 中 `row 1, col 1` 就是第一个主元，然后消除第2、3行的
...
$$
Argumented Matrix = Ab = \begin{pmatrix}
 1 & 2 & 1 & 2\\
  3 & 8 & 1 & 12\\
  0 & 4 & 1 & 2
  \end{pmatrix}
